      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Idea's Infomation</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="body">
              <div class="topic-name">
                <label for="topicName">Idea's title</label>
                <input type="text" class="topicName_input" :value="ideaInfo.title" disabled />
              </div>
              <div class="topic-type">
                <label for="topicType">Topic's type</label>
                <input type="text" class="topicType_input" :value="ideaInfo.type" disabled />
              </div>
